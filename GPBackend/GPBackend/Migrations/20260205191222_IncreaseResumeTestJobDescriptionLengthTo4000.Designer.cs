...
namespace GPBackend.Migrations
{
    ...
    [Migration("20260205191222_IncreaseResumeTestJobDescriptionLengthTo4000")]
    partial class IncreaseResumeTestJobDescriptionLengthTo4000
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GPBackend.Models.CompanyRequest", b =>
                {
            ...
            modelBuilder.Entity("GPBackend.Models.EmailApplicationUpdate", b =>
                {
                    b.Property<int>("EmailApplicationUpdateId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("EmailApplicationUpdateId"));
                    ...
                    b.Property<string>("EmailSnippet")
                        .HasMaxLength(1000)
                        .HasColumnType("nvarchar(1000)");
                    ...
                    b.HasKey("EmailApplicationUpdateId");

                    b.HasIndex("ApplicationId");

                    b.HasIndex("UserId");

                    b.ToTable("EmailApplicationUpdates");
                });
            ...
            modelBuilder.Entity("GPBackend.Models.GmailConnection", b =>
                {
            ...
            modelBuilder.Entity("GPBackend.Models.InterviewQuestionFeedback", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("ImprovementsJson")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("improvements_json");
                    ...
                    b.ToTable("Interview_Question_Feedback", (string)null);
                });

            modelBuilder.Entity("GPBackend.Models.InterviewVideoFeedback", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<double>("Authenticity")
                        .HasColumnType("float")
                    ...
                    b.ToTable("Interview_Video_Feedback", (string)null);
                });
            ...
            modelBuilder.Entity("GPBackend.Models.CompanyRequest", b =>
                {
                    ...
                    b.HasOne("GPBackend.Models.User", "ReviewedByAdmin")
                        .WithMany()
            ...
            modelBuilder.Entity("GPBackend.Models.InterviewQuestionFeedback", b =>
                {
                    b.HasOne("GPBackend.Models.InterviewQuestion", "InterviewQuestion")
                        .WithMany()
