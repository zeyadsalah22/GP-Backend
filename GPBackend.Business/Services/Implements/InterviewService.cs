...
namespace GPBackend.Services.Implements
{
    public class InterviewService : IInterviewService
    {
        ...
        public async Task<InterviewResponseDto?> GetInterviewByIdAsync(int userId, int interviewId)
        {
            ...
            if (interview == null)
            {
                throw new GPBackend.Exceptions.NotFoundException($"Interview with Id {interviewId} not found");
            }
        ...
        public async Task<InterviewResponseDto?> CreateInterviewAsync(int userId, InterviewCreateDto interviewCreateDto)
        {
            ...
            {
                throw new UnauthorizedAccessException("You do not have permission to create this interview");
            }
            ...
            if (interviewCreateDto.ApplicationId == null)
            {
                ...
                {
                    throw new GPBackend.Exceptions.BadRequestException("Job description and position are required when application ID is not provided");
                }
            }
            ...
            {
                throw new GPBackend.Exceptions.NotFoundException($"Failed to retrieve the created interview with Id {createdInterviewId}");
            }
            if(createdInterview.UserId != userId || createdInterview.InterviewId != createdInterviewId)
            {
                throw new UnauthorizedAccessException("You do not have permission to access this interview");
            }
        ...
        public async Task<bool> UpdateInterviewByIdAsync(int userId, int interviewId, InterviewUpdateDto updateInterviewDto)
        {
            ...
            if (interview.UserId != userId)
            {
                throw new UnauthorizedAccessException("You do not have permission to update this interview");
            }
            ...
            if (!updateResult)
            {
                throw new GPBackend.Exceptions.BadRequestException("Failed to update interview");
            }
        ...
        public async Task<bool> DeleteInterviewByIdAsync(int userId, int interviewId)
        {
            ...
            if (interview.UserId != userId)
            {
                throw new UnauthorizedAccessException("You do not have permission to delete this interview");
            }
