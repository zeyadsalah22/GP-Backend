...
namespace GPBackend.Services.Implements
{
    public class ApplicationService : IApplicationService
    {
        ...
        public async Task<ApplicationResponseDto> CreateApplicationAsync(int userId, ApplicationCreateDto createDto)
        {
            ...
            {
                throw new NotFoundException("The specified user-company relationship does not exist");
            }
            ...
            if (createDto.ContactedEmployeeIds != null && createDto.ContactedEmployeeIds.Any())
            {
                ...
                {
                    throw new NotFoundException("One or more employees not found for this application");
                }
            }
            ...
            if (createDto.ContactedEmployeeIds != null && createDto.ContactedEmployeeIds.Any())
            {
                ...
                if (!success)
                {
                    throw new BadRequestException("Failed to add contacted employees to application");
                }
            }
            ...
            {
                throw new NotFoundException($"Failed to retrieve the created application with Id {applicationId}");
            }
        ...
        public async Task<bool> UpdateApplicationAsync(int id, int userId, ApplicationUpdateDto updateDto)
        {
            ...
            if (updateDto.ContactedEmployeeIds != null)
            {
                ...
                if (!success)
                {
                    throw new BadRequestException("Failed to update contacted employees for application");
                }
            }
        ...
        public async Task<bool> RecordStageAsync(int applicationId, int userId, ApplicationStage stage, DateOnly date, string? note = null)
        {
            ...
            if (!updated)
            {
                throw new BadRequestException("Failed to update application stage");
            }
